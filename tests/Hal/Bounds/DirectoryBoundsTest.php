...
class DirectoryBoundsTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testICanGetBoundsForDirectory() {
        ...
        $rs3 = $this->getMockBuilder('\Hal\Result\ResultSet')->disableOriginalConstructor()->getMock();
        ...
        $rs4 = $this->getMockBuilder('\Hal\Result\ResultSet')->disableOriginalConstructor()->getMock();
        ...
        $this->assertInstanceOf('\Hal\Bounds\Result\DirectoryResult', $result);
