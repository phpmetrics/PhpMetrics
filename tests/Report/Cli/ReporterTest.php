...
{
    public function testCliReportIsIgnoredWhenQuietOutput(): void
    {
    ...
    public function provideMetricsToReport(): Generator
    {
        ...
        $expected = <<<EOT
            LOC
                ...
                Logical lines of code by class              719
                Logical lines of code by method             40
    ...
    public function testICanReportToCli(
        Metrics $metrics,
        ...
        Phake::verify($output)->__call('isQuiet', []);
        Phake::verify($output)->__call('write', [$expectedOutput]);
        Phake::verifyNoOtherInteractions($output);
