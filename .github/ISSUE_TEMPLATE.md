...
**The latest version of PhpMetrics is v2.0.0alphaalphaalphaalphaalpha.**. Please try to update PhpMetrics and check if the bug persist before submitting new issue.
